...
[m, n] = size(EEG);
% CHANGE STORE PATH
store_path = strcat('E:\Isaac_D2\M2_codes\subjects_process\Subject06\',out(5),'\');
...
%%
% 
% plot(ECG(1,20000:50000))
% figure;
% plot(ECG(2,20000:50000))
% figure;
% plot(ECG(2,20000:50000)-ECG(1,20000:50000))